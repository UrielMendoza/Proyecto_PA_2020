...
public class EditForm {
	 ...
	 * @param fechaNac
	 */
	public EditForm(String correo, String nombre, String apellido, String telefono, String direccion, 
			String cp, String fechaNac, String estatus, String generacion) {
		this.correo = correo;
		this.nombre = nombre;
