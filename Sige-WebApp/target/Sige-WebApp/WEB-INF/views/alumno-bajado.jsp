...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="http://localhost:8080/Sige-WebApp/h" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="My Account">
    Cerrar Sesión
  </a>
 </div>
</div>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
	...
	<a href="http://localhost:8080/Sige-WebApp/spring/login">
    <button type="button" class="w3-button w3-theme">Regresar</button></a>
	</form:form>
              </div>
            </div>
          </div>
